...
while (True):
    ...
    if ave > best:
        best = ave
    print ('--------------------------------------------------------------------------------')
    print (f'the score it got last was {snake_lanth}')
    print (f'''the average is {ave} (this is not correct until it has died at least 5 time's)''')
    print (f'how many times it has died is {NUMBER}')
    print (f'the best average it got is {best}')
    print (f'the best score it got is {score}')
    blank = (0, 0, 0)
    snake = (50, 125, 0)
    head = '52'
    add = 1
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_k:
                    print (f'ghost_left == {ghost_left}')
                    print (f'ghost_right == {ghost_right}')
                    print (f'ghost_up == {ghost_up}')
                    print (f'ghost_down == {ghost_down}')
                    print (movement)
                    stop_forever = 'yes'
            if event.type == pygame.KEYDOWN:
